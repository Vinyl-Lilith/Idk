...
import { User, MessageSquare, Lock, ArrowLeft, Hexagon } from 'lucide-react'; // eslint-disable-line no-unused-vars
    ...
    <div className="min-h-screen grid-bg flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm animate-slide-up">
        ...
        <div className="glass rounded-2xl p-8 border border-yellow-400/10 relative overflow-hidden">
          <h2 className="text-xs font-mono uppercase tracking-widest text-slate-500 mb-2"><span>// Recovery Request</span></h2>
